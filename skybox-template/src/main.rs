...
void main()
{
    gl_Position = transpose(mat4(
        vec4(0.12511493265628815, -0.21643994748592377, 0.0, 0.0),
        vec4(0.10831947781532758, 0.06261498549435007, -0.21643994748592377, 0.0),
        vec4(0.18738500347083775, 0.10831947781532758, 0.12511493265628815, 0.0),
