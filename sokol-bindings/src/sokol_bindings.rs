...
/// This convenience macro creates a userdata callback for the sapp desc struct.
/// Note that the paramter type indicated *must* be the same as the type of the 
/// userdata field on the given sapp desc struct.
